<?php 
    ...
    class Hasil{
        ...
        public function getDataPreferensi($c1=0,$c2=0,$c3=0,$c4=0,$merek)
        {
            if($merek == "Semua"){
            ...
            GROUP BY a.nama_alternatif ORDER BY preferensi DESC;");
                ...
                JOIN kec_alt_kriteria kak ON a.id_alternatif = kak.f_id_alternatif
                JOIN sub_kriteria sk ON kak.f_id_sub_kriteria = sk.id_sub_kriteria
                JOIN kriteria k ON kak.f_id_kriteria = k.id_kriteria WHERE a.merek = '$merek'
                GROUP BY a.nama_alternatif ORDER BY preferensi DESC;");
            }
            
        } 
        public function getDataPreferensiLimOne($c1=0,$c2=0,$c3=0,$c4=0,$merek)
        {
            if($merek == 'Semua'){
                return $this->db->query("SELECT a.nama_alternatif, a.id_alternatif, a.gambar, a.design, a.merek,
                MAX(CASE WHEN k.nama_kriteria = 'Harga' THEN sk.nama_sub_kriteria END) AS nama_C1,
        ...
        public function simpanRiwayat($id_alternatif_terting,$c1=0,$c2=0,$c3=0,$c4=0,$preferensi){
            $this->db->query("INSERT INTO riwayat (id_riwayat,id_alternatif_terting,c1,c2,c3,c4,preferensi) VALUES (0,$id_alternatif_terting,$c1,$c2,$c3,$c4,$preferensi)");
        }
